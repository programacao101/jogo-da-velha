...
int main (void)
{
    ...
    while (1)
    {
        printf("\e[H\e[2J"); // imprimir isso limpa o terminal
        primeiro = 1;
        ...
        for (int i = 0; i < 3; i++)
        {
            ...
            for (int j = 0; j < 3; j++)
            {
                if (grade[i][j] == 'X') printf("|\x1B[104m‾‾‾‾‾\x1B[0m|");
                else if (grade[i][j] == 'O') printf("|\x1B[41m‾‾‾‾‾\x1B[0m|");
                else printf("|‾‾‾‾‾|");
            }
            ...
            for (int j = 0; j < 3; j++)
            {
                if (grade[i][j] == 'X') printf("|\x1B[104;30m  %c  \x1B[0m|", grade[i][j]);
                else if (grade[i][j] == 'O') printf("|\x1B[37;41m  %c  \x1B[0m|", grade[i][j]);
                else printf("|  %c  |", grade[i][j]);
            }
            ...
            for (int j = 0; j < 3; j++)
            {
                if (grade[i][j] == 'X') printf("|\x1B[104m_____\x1B[0m|");
                else if (grade[i][j] == 'O') printf("|\x1B[41m_____\x1B[0m|");
                else printf("|_____|");
            }
